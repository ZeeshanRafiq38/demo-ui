...
const Rewards = () => {
    return (
        <section className="bg-[#FA1239] rounded-xl ml-8 mr-2 mb-44 relative space-y-8 h-[400px]">
            ...
            <div className="grid grid-cols-4 gap-6 px-12 absolute -bottom-36 w-full">
                <div className="bg-white rounded-lg shadow-md flex flex-col items-center gap-6 py-6">
                    <img src={reward1} className="w-fit" alt="Reward" />
                    <p className="text-lg text-[#032433] w-[150px] text-center">
                        What recruiters actually look for
                    </p>
                </div>
                <div className="bg-white rounded-lg shadow-md flex flex-col items-center gap-6 py-6">
                    <img src={reward2} className="w-fit" alt="Reward" />
                    <p className="text-lg text-[#032433] w-[200px] text-center">
                    How hiring managers make decisions in 6 seconds or less
                    </p>
                </div>
                <div className="bg-white rounded-lg shadow-md flex flex-col items-center gap-6 py-6">
                    <img src={reward3} className="w-fit" alt="Reward" />
                    <p className="text-lg text-[#032433] w-[230px] text-center">
                    How ATS software reads and ranks resumes
                    </p>
                </div>
                <div className="bg-white rounded-lg shadow-md flex flex-col items-center gap-6 py-6">
                    <img src={reward4} className="w-fit" alt="Reward" />
                    <p className="text-lg text-[#032433] w-[200px] text-center">
                    How to turn your experience into value-driven impact statements
                    </p>
                </div>
            </div>
        </section>
